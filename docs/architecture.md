...
4. **Remote + SSH**: CLI or desktop forwards a loopback-bound remote daemon over `ssh -W`, and can install and launch it first when asked to. See [ssh.md](ssh.md)
