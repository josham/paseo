...
| [docs/pdf-preview.md](docs/pdf-preview.md)                           | System PDF viewers per platform, the Android gap, chunked file transfer and its size bounds                                    |
...
| [docs/ssh.md](docs/ssh.md)                                           | SSH remote hosts: `-W` transport, opt-in remote install/launch, the ensure-script contract, askpass prompting                  |
...
| [docs/devcontainers.md](docs/devcontainers.md)                       | Dev containers — launch strategies, exec gotchas, what crosses into the container, what stays on the host                      |
