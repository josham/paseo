...
export const zhCN: TranslationResources = {
  ...
  panels: {
    ...
    codeNavigation: {
      goToDefinition: "转到定义",
      findUsages: "查找用法",
      copySymbol: "复制“{{symbol}}”",
      selectText: "选择文本",
      doneSelecting: "完成",
      selectingHint: "选择要复制的文本",
      finding: "正在查找 {{symbol}}…",
      opened: "已打开 {{location}}",
      noDefinition: "未找到 {{symbol}} 的定义",
      noUsages: "未找到 {{symbol}} 的用法",
      unsupportedLanguage: "没有语言服务器支持此文件类型",
      serverNotInstalled: "请在主机上安装 {{commands}} 以浏览此文件",
      containerNotRunning: "请启动工作区容器以浏览其代码",
      notAWorkspace: "代码导航仅在工作区内可用",
      disabled: "主机配置中已关闭代码导航",
      failed: "代码导航失败：{{message}}",
      partial: "仍在建立索引，结果可能不完整",
      truncated: "显示前 {{count}} 个结果",
      definitionsOf: "{{symbol}} 的定义",
      usagesOf: "{{symbol}} 的用法",
      ...
      refresh: "刷新",
      containerOnly: "仅在容器内",
      removedLine: "已删除的行不在磁盘上",
      notOnDisk: "仅适用于未提交的更改",
      orSeparator: " 或 ",
    },
    files: {
      label: "文件",
