export const en = {
  ...
  panels: {
    ...
    codeNavigation: {
      ...
      doneSelecting: "Done",
      selectingHint: "Select text to copy",
      finding: "Looking up {{symbol}}…",
      opened: "Opened {{location}}",
      noDefinition: "No definition found for {{symbol}}",
      noUsages: "No usages found for {{symbol}}",
      unsupportedLanguage: "No language server handles this file type",
      serverNotInstalled: "Install {{commands}} on the host to navigate this file",
      containerNotRunning: "Start the workspace's container to navigate its code",
      notAWorkspace: "Code navigation works only inside a workspace",
      disabled: "Code navigation is turned off in the host's config",
      failed: "Code navigation failed: {{message}}",
      partial: "Still indexing, so results may be incomplete",
      truncated: "Showing the first {{count}} results",
      definitionsOf: "Definitions of {{symbol}}",
      usagesOf: "Usages of {{symbol}}",
      resultCount_one: "{{count}} result",
      resultCount_other: "{{count}} results",
      searching: "Searching…",
      refresh: "Refresh",
      containerOnly: "Inside the container only",
      removedLine: "Removed lines are not on disk",
      notOnDisk: "Available for uncommitted changes only",
      orSeparator: " or ",
    },
    files: {
      label: "Files",
