...
export const ko: TranslationResources = {
  ...
  panels: {
    ...
    codeNavigation: {
      ...
      findUsages: "사용 위치 찾기",
      copySymbol: "“{{symbol}}” 복사",
      selectText: "텍스트 선택",
      doneSelecting: "완료",
      selectingHint: "복사할 텍스트를 선택하세요",
      finding: "{{symbol}} 찾는 중…",
      opened: "{{location}} 열림",
      noDefinition: "{{symbol}}의 정의를 찾을 수 없습니다",
      noUsages: "{{symbol}}의 사용 위치를 찾을 수 없습니다",
      unsupportedLanguage: "이 파일 형식을 처리하는 언어 서버가 없습니다",
      serverNotInstalled: "이 파일을 탐색하려면 호스트에 {{commands}}을(를) 설치하세요",
      containerNotRunning: "코드를 탐색하려면 작업 공간의 컨테이너를 시작하세요",
      notAWorkspace: "코드 탐색은 작업 공간 안에서만 작동합니다",
      disabled: "호스트 설정에서 코드 탐색이 꺼져 있습니다",
      failed: "코드 탐색 실패: {{message}}",
      partial: "아직 인덱싱 중이라 결과가 불완전할 수 있습니다",
      truncated: "처음 {{count}}개 결과를 표시합니다",
      definitionsOf: "{{symbol}}의 정의",
      usagesOf: "{{symbol}}의 사용 위치",
      resultCount_one: "결과 {{count}}개",
      resultCount_other: "결과 {{count}}개",
      searching: "찾는 중…",
      refresh: "새로 고침",
      containerOnly: "컨테이너 안에서만",
      removedLine: "삭제된 줄은 디스크에 없습니다",
      notOnDisk: "커밋되지 않은 변경 사항에서만 사용할 수 있습니다",
      orSeparator: " 또는 ",
    },
    files: {
      label: "파일",
