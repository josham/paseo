...
export const ar: TranslationResources = {
  ...
  panels: {
    ...
    codeNavigation: {
      ...
      findUsages: "البحث عن الاستخدامات",
      copySymbol: "نسخ «{{symbol}}»",
      selectText: "تحديد نص",
      doneSelecting: "تم",
      selectingHint: "حدّد نصًا لنسخه",
      finding: "جارٍ البحث عن {{symbol}}…",
      opened: "تم فتح {{location}}",
      noDefinition: "لم يُعثر على تعريف لـ {{symbol}}",
      noUsages: "لم يُعثر على استخدامات لـ {{symbol}}",
      unsupportedLanguage: "لا يوجد خادم لغة يدعم هذا النوع من الملفات",
      serverNotInstalled: "ثبّت {{commands}} على المضيف للتنقل في هذا الملف",
      containerNotRunning: "شغّل حاوية مساحة العمل للتنقل في شيفرتها",
      notAWorkspace: "التنقل في الشيفرة يعمل داخل مساحة عمل فقط",
      disabled: "التنقل في الشيفرة معطّل في إعدادات المضيف",
      failed: "فشل التنقل في الشيفرة: {{message}}",
      partial: "ما زالت الفهرسة جارية، لذا قد تكون النتائج ناقصة",
      truncated: "عرض أول {{count}} نتيجة",
      definitionsOf: "تعريفات {{symbol}}",
      usagesOf: "استخدامات {{symbol}}",
      resultCount_one: "{{count}} نتيجة",
      resultCount_other: "{{count}} نتيجة",
      searching: "جارٍ البحث…",
      refresh: "تحديث",
      containerOnly: "داخل الحاوية فقط",
      removedLine: "الأسطر المحذوفة لم تعد على القرص",
      notOnDisk: "متاح للتغييرات غير المُثبّتة فقط",
      orSeparator: " أو ",
    },
    files: {
      label: "الملفات",
