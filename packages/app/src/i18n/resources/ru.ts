  ...
  workspace: {
    ...
    header: {
      ...
      container: {
        ...
        isolateAction: "Выделить этому рабочему пространству свой контейнер",
        shareAction: "Использовать общий контейнер этой копии",
        scopeConfirmTitle: "Изменить изоляцию контейнера",
        scopeIsolateConfirmMessage:
          "Рабочее пространство получит собственный контейнер, собранный с нуля, и собственную копию каждой службы, объявленной проектом. Эти копии начнутся пустыми. Используемый сейчас контейнер будет удалён.",
        scopeShareConfirmMessage:
          "Рабочее пространство вернётся к одному общему контейнеру на копию репозитория. Его отдельный контейнер будет удалён вместе с данными, которые хранились только внутри него.",
      },
      toasts: {
