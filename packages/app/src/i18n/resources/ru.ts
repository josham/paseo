...
export const ru: TranslationResources = {
  ...
  panels: {
    ...
    codeNavigation: {
      ...
      findUsages: "Найти использования",
      copySymbol: "Копировать «{{symbol}}»",
      selectText: "Выделить текст",
      doneSelecting: "Готово",
      selectingHint: "Выделите текст для копирования",
      finding: "Поиск {{symbol}}…",
      opened: "Открыто: {{location}}",
      noDefinition: "Определение {{symbol}} не найдено",
      noUsages: "Использования {{symbol}} не найдены",
      unsupportedLanguage: "Ни один языковой сервер не поддерживает этот тип файла",
      serverNotInstalled: "Установите {{commands}} на хосте для навигации по этому файлу",
      containerNotRunning: "Запустите контейнер рабочей области для навигации по коду",
      notAWorkspace: "Навигация по коду работает только внутри рабочей области",
      disabled: "Навигация по коду отключена в конфигурации хоста",
      failed: "Ошибка навигации по коду: {{message}}",
      partial: "Индексация ещё идёт, результаты могут быть неполными",
      truncated: "Показаны первые {{count}} результатов",
      definitionsOf: "Определения {{symbol}}",
      usagesOf: "Использования {{symbol}}",
      resultCount_one: "{{count}} результат",
      resultCount_other: "Результатов: {{count}}",
      searching: "Поиск…",
      refresh: "Обновить",
      containerOnly: "Только внутри контейнера",
      removedLine: "Удалённых строк больше нет на диске",
      notOnDisk: "Доступно только для незафиксированных изменений",
      orSeparator: " или ",
    },
    files: {
      label: "Файлы",
