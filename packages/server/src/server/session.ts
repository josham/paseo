...
export class Session {
  ...
  // A flat list of dispatchers, one per message family; adding the container family
  // takes the count to 21. The chain is exhaustive by design and splitting it would
  // hide the dispatch order.
  // oxlint-disable-next-line eslint(complexity): one dispatcher per message family
